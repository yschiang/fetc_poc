...
var mycase;
if (parsedURL.pathname.indexOf('/smsByCarno') != -1) {
    mycase = "smsByCarno";
} else if (parsedURL.pathname.indexOf('/smsByEPCID') != -1) {
    mycase = "smsByEPCID";
} else {
...
async.series([
    ...
    function(callback) {
        ...
        let postData = {
            "apiName": "PutSMSQueue",
            "Body": (",1, " + data.lprNumber + ", 34127457," + data.smsContent + "," + data.johnsonPhone)
        };
